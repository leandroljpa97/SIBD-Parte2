...
insert into species values ('bulldog', 'gin');
insert into species values ('pug', 'looks... ugly');
insert into species values ('rottweiler', 'looks angry');
insert into species values ('bird', 'piu piu');
insert into species values ('clown', 'human''s best friend');
insert into species values ('cat', 'kinda grumpy. but if it fits, it sits!');
insert into species values ('fish', 'humans best friend');
...
insert into generalization_species values ('clown', 'fish');

insert into animal values ('doge', '000000000', 'bulldog', 'yellow', 'male', '1997-12-20', 20);
...
('alilas', '000000002', '2005-7-30 09:00:30.75', 's', 'obese', 'a', 'p', '000000002', '000000004', 50),
...
('alilandro', '000000007', '2017-11-29 09:00:30.75', 's', 'o', 'a', 'p', '000000007', '000000009', 50);
